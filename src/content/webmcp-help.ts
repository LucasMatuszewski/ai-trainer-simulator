...
export const AGENT_PROMPT = [
  ...
  "   yet, the join is QUEUED: tell me to start it - the robot walks in on its own when it",
  "   loads, and my next message wakes you to do your entrance. 3) Discover native host",
