...
export const AGENT_PROMPT = [
  ...
  "   start it, then KEEP YOUR LOOP: wait_for_office({timeout_seconds: 120}) and re-arm it",
  "   on every {waiting:true}; the moment it returns loaded, do your entrance. Never stop",
  "   and never wait for a message. 3) Discover native host",
  ...
  "answering and after {waiting:true}. Respect conversationEnded goodbyes.",
